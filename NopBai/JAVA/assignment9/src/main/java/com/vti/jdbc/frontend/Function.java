...
public class Function {
	...
	public void updateTrainee() {
		...
		Trainee trainee = new Trainee();
		System.out.println("UserName: ");
		trainee.setUserName(ScannerUtil.readString(sc, "Null! \nTry again"));
		System.out.println("FirstName: ");
		trainee.setFirstName(ScannerUtil.readString(sc, "Null! \nTry again"));
		System.out.println("LastName: ");
		trainee.setLastName(ScannerUtil.readString(sc, "Null! \nTry again"));
		System.out.println("Email: ");
		trainee.setEmail(ScannerUtil.readString(sc, "Null! \nTry again"));
		System.out.println("PassWord: ");
		trainee.setPassWord(ScannerUtil.readString(sc, "Null! \nTry again"));
